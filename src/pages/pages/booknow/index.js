  ...
  return (
    <Card>
        ...
        <Table sx={{ minWidth: 800 }} aria-label='table in dashboard'>
          ...
          {(listData.length == 0) ? <TableRow hover sx={{ '&:last-of-type td, &:last-of-type th': { border: 0 } }}>
              ...
              <TableRow hover key={row.id} sx={{ '&:last-of-type td, &:last-of-type th': { border: 0 } }}>
                ...
                <TableCell>
                  {row.status == 'Booked' ? <Button disabled={true} variant='outlined' sx={{ color: 'grey' }}>Already Booked</Button> : <Button variant='outlined' sx={{ color: 'blue' }} onClick={() => handleClickOpen(row.worker_id)}>Book Now</Button>
 }
                  <Dialog
        open={open}
        keepMounted
      ...
      <DateCalendar disablePast onChange={(e) => {
        ...
        setDay(e['$D']);
            ...
            {cloths == 1 ? <Typography
          variant="secondary"> Amount: ₹50 </Typography> : cloths == 2 ? <Typography
          variant="secondary"> Amount: ₹100</Typography> : cloths == 3 ? <Typography
          variant="secondary"> Amount: ₹150</Typography> : cloths == 4 ? <Typography
    ...
    {day != '' ? <Grid item xs={12} sm={12}>
            <FormControl fullWidth>
              ...
              <Select label='Location' defaultValue='- Select -' onChange={(e) => setLocation(e.target.value)}>
                <MenuItem value='- Select -' selected disabled>- Select -</MenuItem>
